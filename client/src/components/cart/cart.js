        ...
        <div class="flex items-center flex-col lg:flex-row">
          ...
          <div class="lg:ml-6 flex-grow">
            ...
            <div class="mb-4">
              ...
              <DatePicker value={value} onChange={(res) => setAmount(getAllDatesInRange(res))} range={true} />
            </div>
          </div>
          ...
          <button className="bg-themeRed text-white w-1/6 p-2 rounded-md ">Pay ${amount.length * 100}</button>
         </div>
 </div>

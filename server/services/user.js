...
exports.updateUser = async (req, res) => {
  ...
  try {
    ...
    const user = (await query(`SELECT * from ${userDetails} where name = '${body.name}', email_id = '${body.email_id}'`))[0]
    const result =
      await query(`UPDATE ${userTable} SET (name, logo_url, email_id, password, phone_number, city, address)
        VALUES (
        '${body.name}',
        '${body.logo_url || ""}',
        '${body.email_id}',
